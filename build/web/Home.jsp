...
<html>
  ...
  <body>
    <div class="container">
                ...
                <div class="featured  w-[95%] lg:w-[65%] mx-auto mb-25">
                    <div class="grid grid-cols-2 gap-4">
                        <div class="lh-product-card h-[540px]">
                            <div
                                class="h-[540px] bg-[url(./images/bag-2-1613919671.jpg)] bg-cover bg-no-repeat bg-center">
                        ...
                        <div class="lh-product-card h-[540px]">
                            <div
                                class="h-[540px] bg-[url(./images/louis-vuitton-x-nba-2020-14.jpg)] bg-cover bg-no-repeat bg-center">
                ...
                <div class="more-product  w-[95%] lg:w-[65%] mx-auto mb-25">
                    <div class="grid grid-cols-1  md:grid-cols-2 gap-4 lg:grid-cols-3 gap-8">
                        <div class="lh-product-card">
                            <div class="h-[330px] bg-[url(./images/mr8.png)] bg-cover bg-no-repeat bg-center">
                                <a href="#" alt="BestSeller1">
                                    <div class="w-full h-full hover:bg-gray-900 hover:bg-opacity-10 after::transition-all a:ease-in-out 
                                    after:duration-500 
                                    relative group">
                        ...
                        <div class="lh-product-card">
                            <div class="h-[330px] bg-[url(./images/mr7.png)] bg-cover bg-no-repeat bg-center">
                                <a href="#" alt="BestSeller1">
                                    <div class="w-full h-full hover:bg-gray-900 hover:bg-opacity-10 after::transition-all a:ease-in-out 
                                    after:duration-500 
                                    relative group">
                        ...
                        <div class="lh-product-card">
                            <div class="h-[330px] bg-[url(./images/mr6.jpg)] bg-cover bg-no-repeat bg-center">
                                <a href="#" alt="BestSeller1">
                                    <div class="w-full h-full hover:bg-gray-900 hover:bg-opacity-10 after::transition-all a:ease-in-out 
                                    after:duration-500 
                                    relative group">
                        ...
                        <div class="lh-product-card">
                            <div class="h-[330px] bg-[url(./images/mr5.png)] bg-cover bg-no-repeat bg-center">
                                <a href="#" alt="BestSeller1">
                                    <div class="w-full h-full hover:bg-gray-900 hover:bg-opacity-10 after::transition-all a:ease-in-out 
                                    after:duration-500 
                                    relative group">
                        ...
                        <div class="lh-product-card">
                            <div class="h-[330px] bg-[url(./images/mr4.jpg)] bg-cover bg-no-repeat bg-center">
                                <a href="#" alt="BestSeller1">
                                    <div class="w-full h-full hover:bg-gray-900 hover:bg-opacity-10 after::transition-all a:ease-in-out 
                                    after:duration-500 
                                    relative group">
                        ...
                        <div class="lh-product-card">
                            <div class="h-[330px] bg-[url(./images/mr3.jpg)] bg-cover bg-no-repeat bg-center">
                                <a href="#" alt="BestSeller1">
                                    <div class="w-full h-full hover:bg-gray-900 hover:bg-opacity-10 after::transition-all a:ease-in-out 
                                    after:duration-500 
                                    relative group">
        ...
        <div class="lh-subheadline flex justify-center items-center my-24">
            <div class="lh-subheadline-deco-line w-8 h-px bg-gray-400"></div>
            <div class="lh-subheadline-label uppercase mx-4 tracking-widest font-medium text-[13px]">magazine
            </div>
            <div class="lh-subheadline-deco-line w-8 h-px bg-gray-400"></div>
        </div>
        <div class="magazine">
